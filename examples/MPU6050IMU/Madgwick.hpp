...
// estimate of relative device orientation
void MadgwickQuaternionUpdate(float ax, float ay, float az, float gx, float gy, float gz, float deltat, float beta, float zeta, float q[4])
{
