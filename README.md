...
For example, you can specify that a Level PID controller will be active in switch state 1 (or higher) and a 
[Loiter](https://github.com/simondlevy/Hackflight/blob/master/src/pidcontrollers/loiter.hpp)
