...
namespace hf {
    ...
    class Hackflight : public MspParser {
        ...
        private: 
            ...
            {
                return fabs(_state.pose.rotation[axis]) < _ratePid->maxArmingAngle;
            }
            ...
            void checkReceiver(void)
            {
                ...
                if (!_receiver->getDemands(_state.pose.rotation[AXIS_YAW] - _yawInitial)) return;
                ...
                if (    _safeToArm &&
                    ...
                    _state.armed = true;
                    _yawInitial = _state.pose.rotation[AXIS_YAW]; // grab yaw for headless mode
                }
        ...
        protected:
                    ...
                    float & heading, float & velocityForward, float & velocityRightward) 
            {
                ...
                positionX = 0;
                positionY = 0;
                heading = -_state.pose.rotation[AXIS_YAW]; // NB: Angle negated for remote visualization
                velocityForward = 0;
                velocityRightward = 0;
            }
            ...
            {
                roll  = _state.pose.rotation[AXIS_ROLL];
                pitch = _state.pose.rotation[AXIS_PITCH];
                yaw   = _state.pose.rotation[AXIS_YAW];
            }
