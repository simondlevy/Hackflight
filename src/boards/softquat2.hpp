/*
   sofquat2.hpp : Abstract class for boards that need to compute the quaternion on the MCU, with different udpate
   rates for accelerometer and gyro
...
namespace hf {
    ...
    class SoftwareQuaternionBoard2 {
