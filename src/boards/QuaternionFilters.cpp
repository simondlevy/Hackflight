...
MadgwickQuaternion::MadgwickQuaternion(float beta)
{
    this->_beta = beta;
}

void MadgwickQuaternion::update(float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz, float deltat, float q[4])
{
...
MahonyQuaternion::MahonyQuaternion(void)
{
    _eInt[0] = 0;
    _eInt[1] = 0;
    _eInt[2] = 0;
...
void MahonyQuaternion::update(float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz, float deltat, float q[4])
{
    float q1 = q[0], q2 = q[1], q3 = q[2], q4 = q[3];   // short name local variable for readability
    float norm;
    float hx, hy, bx, bz;
