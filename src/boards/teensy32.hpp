/*
   teensy32.hpp : Implementation of Hackflight Board routines for Teensy3.2
...
namespace hf {
    ...
    class Teensy32 : public RealBoard {
        ...
        private:
            ...
            // Teensy32 board follows Arduino standard for LED pin
            const uint8_t LED_PIN = 13;

            // MPU9250 add-on board has interrupt on Teensy32 pin 8
