...
namespace hf {
    ...
    class NewSpringyReceiver {
        ...
        public:
            ...
            NewSpringyReceiver& operator=(
                    const NewSpringyReceiver& other) = default;

            static auto update(
                    const NewSpringyReceiver & data,
                    ...
                    const uint16_t aux1,
                    const uint16_t aux2,
                    const uint32_t msec_curr) -> NewSpringyReceiver
            {
                ...
                return NewSpringyReceiver(
                        traditional.axes,
                        traditional.is_armed,
                        is_hovering,
                        traditional.timestamp_msec,
                        aux1,
                        aux2);
            }
