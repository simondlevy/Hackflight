    ...
    void dispatchMessage(void)
    {
        switch (_command) {
            ...
            case 123: 
                ...
                float vals[2]; 
                handle_GET_ALTITUDE_METERS(vals[0], vals[1]);
                sendFloats(vals, 2);
                } break;
            ...
            case 121: 
                ...
                float vals[6]; 
                handle_GET_RC_NORMAL(vals[0], vals[1], vals[2], vals[3], vals[4], vals[5]);
                sendFloats(vals, 6);
                } break;
            ...
            case 122: 
                ...
                float vals[3];
                handle_GET_ATTITUDE_RADIANS(vals[0], vals[1], vals[2]);
                sendFloats(vals, 3);
                } break;
