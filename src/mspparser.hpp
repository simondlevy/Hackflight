...
namespace hf {
    ...
    class MspParser {
            ...
            void dispatchRequestMessage(void)
            {
                switch (_command) {
                    ...
                    case 222:
                    {
                        ...
                        uint8_t c5 = 0;
                        memcpy(&c5,  &_inBuf[4], sizeof(uint8_t));

                        uint8_t c6 = 0;
                        memcpy(&c6,  &_inBuf[5], sizeof(uint8_t));

                        handle_SET_RC_BYTES_Request(c1, c2, c3, c4, c5, c6);
                        } break;
        ...
        protected:
            ...
            virtual void handle_SET_RC_BYTES_Request(uint8_t  c1, uint8_t  c2, uint8_t  c3, uint8_t  c4, uint8_t  c5, uint8_t  c6)
            {
                (void)c1;
                (void)c2;
                (void)c3;
            ...
            virtual void handle_SET_RC_BYTES_Data(uint8_t  c1, uint8_t  c2, uint8_t  c3, uint8_t  c4, uint8_t  c5, uint8_t  c6)
            {
                (void)c1;
                (void)c2;
                (void)c3;
        ...
        public:
            ...
            static uint8_t serialize_SET_RC_BYTES(uint8_t bytes[], uint8_t  c1, uint8_t  c2, uint8_t  c3, uint8_t  c4, uint8_t  c5, uint8_t  c6)
            {
                bytes[0] = 36;
                bytes[1] = 77;
                bytes[2] = 62;
                ...
                memcpy(&bytes[9], &c5, sizeof(uint8_t));
                memcpy(&bytes[10], &c6, sizeof(uint8_t));
