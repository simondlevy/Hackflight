...
#include <pidcontrol/pids/pitchroll_angle.hpp>
#include <pidcontrol/pids/pitchroll_rate.hpp>
#include <pidcontrol/pids/yaw_angle.hpp>
#include <pidcontrol/pids/yaw_rate.hpp>
    ...
    class PidControl {
        ...
        public:
            ...
            Setpoint run(
                    ...
                    const Setpoint & openLoopDemands)
            {
                Setpoint setpoint = {};
