...
<a href="https://www.youtube.com/watch?v=mobemDcX9ew"><img src="media/IndoorScene.png" width=500 align=left></a>

<a href="https://www.youtube.com/watch?v=h6107MBgQ98"><img src="media/Mars.png" width=500 align=right></a>
...
through the [Joystick](https://github.com/simondlevy/HackflightSim/blob/master/Source/MainModule/joystick/Joystick.h) class:
...
4. Double-click on the resulting <b>HackflightSim.sln</b> file to launch VisualStudio.
to build the project.

5. In Visual Studio, edit the file
   [HackflightSim/Source/HackflightModule/HackflightModule.Build.cs](https://github.com/simondlevy/HackflightSim/blob/master/Source//HackflightModule/HackflightModule.Build.cs#L16-L17)
...
7. In UnrealEditor, select one of the maps in <b>Content/HackflightSim/Maps</b>. Then open the
...
[OpenCVCamera](https://github.com/simondlevy/HackflightSim/blob/master/Source/HackflightModule/OpenCVCamera.hpp)
class you can run different kinds of machine-vision algorithms.

# Support for other programming languages / packages

HackflightSim supports other programming languages via the SocketModule.  
An Python example is provided. To use this module, do the following:

1. Double-click <b>use_socket.bat</b>

2. Right-click on the <b>HackflightSim.uproject</b> 
file and select <b>Generate Visual Studio project file</b> to generate a <b>.sln</b> file

3. Double-click on the resulting <b>HackflightSim.sln</b> file to launch VisualStudio.
to build the project.

4. In VisualStudio, hit the F5 key to build the project and launch UnrealEditor.

5. In UnrealEditor, select one of the maps in <b>Content/HackflightSim/Maps</b>. Then open the
...
[this folder](https://github.com/simondlevy/HackflightSim/tree/master/Extras/python).

# Design principles

The core of HackflightSim is the abstract C++ 
[FlightManager](https://github.com/simondlevy/HackflightSim/blob/master/Source/MainModule/FlightManager.hpp) 
...
[class](https://github.com/simondlevy/HackflightSim/blob/master/Source/MainModule/Dynamics.hpp)
...
[getMotors](https://github.com/simondlevy/HackflightSim/blob/master/Source/MainModule/FlightManager.hpp#L26-L35)
...
similar manner, the 
[Camera](https://github.com/simondlevy/HackflightSim/blob/master/Source/MainModule/Camera.hpp)
...
[TargetManager](https://github.com/simondlevy/HackflightSim/blob/master/Source/MainModule/TargetManager.hpp)
