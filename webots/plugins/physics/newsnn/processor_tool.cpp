...
int main(int argc, char **argv) 
{
    ...
    while(1) {
        try {
            ...
            else if (sv[0] == "TRACK_O" || sv[0] == "UNTRACK_O") { 
                if (network_processor_validation(net, p)) {
                    if (sv.size() == 1) {
                        if (sv[0][0] == 'T') {
            ...
            else if (sv[0] == "TRACK_N" || sv[0] == "UNTRACK_N") { 
                if (network_processor_validation(net, p)) {
                    if (sv.size() == 1) {
                        if (sv[0][0] == 'T') {
