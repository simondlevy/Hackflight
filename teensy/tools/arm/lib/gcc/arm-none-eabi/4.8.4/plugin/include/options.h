...
enum opt_code
{
  ...
  OPT_mnew_generic_costs = 1058,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1059,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1060,     /* -mpic-data-is-text-relative */
  ...
  OPT_mslow_flash_data = 1065,               /* -mslow-flash-data */
