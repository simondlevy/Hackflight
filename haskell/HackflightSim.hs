...
hackflight :: Receiver -> WorldParams -> VehicleParams -> [PidFun] -> Mixer -> Motors

hackflight receiver wparams vparams pidfuns mixer = motors
  ...
  where
    ...
    state = dynamics wparams vparams (motors' motors)
