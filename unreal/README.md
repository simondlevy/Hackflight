...
HackflightUnreal is a simple multicopter flight simulator using Unreal Engine 4.  It runs on Windows.
...
HackflightUnreal differs from AirSim in a few important ways:
* HackflightUnreal can be used with the same simple flight-control 
...
* HackflightUnreal is tiny, under 2,000 lines of code.
* HackflightUnreal focuses exclusively on multirotor firmware, whereas AirSim
...
I am currently developing HackflightUnreal on an HP Z440 workstation with 32GB
...
1. Clone this repostitory (HackflightUnreal) into your
<b>Documents/Unreal Projects</b> folder, first creating that folder if it
doesn't exist.

2. Double-click <b>use_quickstart.bat</b>
   
3. Right-click on the <b>HackflightUnreal.uproject</b> 
file and select <b>Generate Visual Studio project file</b> to generate a <b>.sln</b> file

4. Double-click on the resulting <b>HackflightUnreal.sln</b> file to launch VisualStudio.  The first time
...
6. In UnrealEditor, select one of the maps in <b>Content/HackflightUnreal/Maps</b>. Then open the
...
Although HackflightUnreal is designed to work with any flight-control software
...
controller or R/C transmitter.  HackflightUnreal currently supports the following controllers
through the [Joystick](https://github.com/simondlevy/HackflightUnreal/blob/master/Source/MainModule/joystick/Joystick.h) class:
...
If you don't have a controller, HackflightUnreal will use input from the numeric keypad on your keyboard (make sure
...
To get HackflightUnreal working with Hackflight, you should do the following:
...
where HackflightUnreal looks for the Hackflight firmware.)
...
4. Double-click on the resulting <b>HackflightUnreal.sln</b> file to launch VisualStudio.
to build the project.

5. In Visual Studio, edit the file
   [HackflightUnreal/Source/HackflightModule/HackflightModule.Build.cs](https://github.com/simondlevy/HackflightUnreal/blob/master/Source//HackflightModule/HackflightModule.Build.cs#L16-L17)
...
7. In UnrealEditor, select one of the maps in <b>Content/HackflightUnreal/Maps</b>. Then open the
...
[OpenCVCamera](https://github.com/simondlevy/HackflightUnreal/blob/master/Source/HackflightModule/OpenCVCamera.hpp)
class you can run different kinds of machine-vision algorithms.

# Support for other programming languages / packages

HackflightUnreal supports other programming languages via the SocketModule.  
An Python example is provided. To use this module, do the following:

1. Double-click <b>use_socket.bat</b>

2. Right-click on the <b>HackflightUnreal.uproject</b> 
file and select <b>Generate Visual Studio project file</b> to generate a <b>.sln</b> file

3. Double-click on the resulting <b>HackflightUnreal.sln</b> file to launch VisualStudio.
to build the project.

4. In VisualStudio, hit the F5 key to build the project and launch UnrealEditor.

5. In UnrealEditor, select one of the maps in <b>Content/HackflightUnreal/Maps</b>. Then open the
...
[this folder](https://github.com/simondlevy/HackflightUnreal/tree/master/Extras/python).

# Design principles

The core of HackflightUnreal is the abstract C++ 
[FlightManager](https://github.com/simondlevy/HackflightUnreal/blob/master/Source/MainModule/FlightManager.hpp) 
...
[class](https://github.com/simondlevy/HackflightUnreal/blob/master/Source/MainModule/Dynamics.hpp)
...
[getMotors](https://github.com/simondlevy/HackflightUnreal/blob/master/Source/MainModule/FlightManager.hpp#L26-L35)
...
similar manner, the 
[Camera](https://github.com/simondlevy/HackflightUnreal/blob/master/Source/MainModule/Camera.hpp)
...
[TargetManager](https://github.com/simondlevy/HackflightUnreal/blob/master/Source/MainModule/TargetManager.hpp)
