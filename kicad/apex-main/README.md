...
using 0.2-0.8mm fine/conical tip.  To avoid soldering a bridge (short circuit), you should solder only the three indicated
pins (3V3, GND, SDA, SCL), and in the bottom corners for additional security.
