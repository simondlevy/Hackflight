 ...
 *
 * param_macros.h - Crazy parameter system header file.
 */
...
#define PARAM_ADD_FULL(TYPE, NAME, ADDRESS, CALLBACK, DEFAULT_GETTER) \
    { .type = ((TYPE) <= 0xFF) ? (TYPE) : (((TYPE) | PARAM_EXTENDED) & 0xFF), \
      ...
      .getter = (getter_t)DEFAULT_GETTER, },
 ...
 *
 * The algo parameters are considered part of the official API and are guaranteed
