...
LOG_GROUP_STOP(supervisor)
    ...
    LOG_ADD(LOG_FLOAT, stateX, &estimatorTask.kalmanData.S[Estimator::KC_STATE_X])
    LOG_ADD(LOG_FLOAT, stateY, &estimatorTask.kalmanData.S[Estimator::KC_STATE_Y])
    LOG_ADD(LOG_FLOAT, stateZ, &estimatorTask.kalmanData.S[Estimator::KC_STATE_Z])
    LOG_ADD(LOG_FLOAT, statePX, &estimatorTask.kalmanData.S[Estimator::KC_STATE_PX])
    LOG_ADD(LOG_FLOAT, statePY, &estimatorTask.kalmanData.S[Estimator::KC_STATE_PY])
    LOG_ADD(LOG_FLOAT, statePZ, &estimatorTask.kalmanData.S[Estimator::KC_STATE_PZ])
    LOG_ADD(LOG_FLOAT, stateD0, &estimatorTask.kalmanData.S[Estimator::KC_STATE_D0])
    LOG_ADD(LOG_FLOAT, stateD1, &estimatorTask.kalmanData.S[Estimator::KC_STATE_D1])
    LOG_ADD(LOG_FLOAT, stateD2, &estimatorTask.kalmanData.S[Estimator::KC_STATE_D2])
    LOG_ADD(LOG_FLOAT, varX, &estimatorTask.kalmanData.P[Estimator::KC_STATE_X][Estimator::KC_STATE_X])
    LOG_ADD(LOG_FLOAT, varY, &estimatorTask.kalmanData.P[Estimator::KC_STATE_Y][Estimator::KC_STATE_Y])
    LOG_ADD(LOG_FLOAT, varZ, &estimatorTask.kalmanData.P[Estimator::KC_STATE_Z][Estimator::KC_STATE_Z])
    LOG_ADD(LOG_FLOAT, varPX, &estimatorTask.kalmanData.P[Estimator::KC_STATE_PX][Estimator::KC_STATE_PX])
    LOG_ADD(LOG_FLOAT, varPY, &estimatorTask.kalmanData.P[Estimator::KC_STATE_PY][Estimator::KC_STATE_PY])
    LOG_ADD(LOG_FLOAT, varPZ, &estimatorTask.kalmanData.P[Estimator::KC_STATE_PZ][Estimator::KC_STATE_PZ])
    LOG_ADD(LOG_FLOAT, varD0, &estimatorTask.kalmanData.P[Estimator::KC_STATE_D0][Estimator::KC_STATE_D0])
    LOG_ADD(LOG_FLOAT, varD1, &estimatorTask.kalmanData.P[Estimator::KC_STATE_D1][Estimator::KC_STATE_D1])
    LOG_ADD(LOG_FLOAT, varD2, &estimatorTask.kalmanData.P[Estimator::KC_STATE_D2][Estimator::KC_STATE_D2])
