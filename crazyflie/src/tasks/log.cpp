...
LOG_GROUP_STOP(supervisor)
    ...
    LOG_ADD(LOG_FLOAT, stateX, &estimatorTask.kalmanData.S[KalmanFilter::KC_STATE_X])
    LOG_ADD(LOG_FLOAT, stateY, &estimatorTask.kalmanData.S[KalmanFilter::KC_STATE_Y])
    LOG_ADD(LOG_FLOAT, stateZ, &estimatorTask.kalmanData.S[KalmanFilter::KC_STATE_Z])
    LOG_ADD(LOG_FLOAT, statePX, &estimatorTask.kalmanData.S[KalmanFilter::KC_STATE_PX])
    LOG_ADD(LOG_FLOAT, statePY, &estimatorTask.kalmanData.S[KalmanFilter::KC_STATE_PY])
    LOG_ADD(LOG_FLOAT, statePZ, &estimatorTask.kalmanData.S[KalmanFilter::KC_STATE_PZ])
    LOG_ADD(LOG_FLOAT, stateD0, &estimatorTask.kalmanData.S[KalmanFilter::KC_STATE_D0])
    LOG_ADD(LOG_FLOAT, stateD1, &estimatorTask.kalmanData.S[KalmanFilter::KC_STATE_D1])
    LOG_ADD(LOG_FLOAT, stateD2, &estimatorTask.kalmanData.S[KalmanFilter::KC_STATE_D2])
    LOG_ADD(LOG_FLOAT, varX, &estimatorTask.kalmanData.P[KalmanFilter::KC_STATE_X][KalmanFilter::KC_STATE_X])
    LOG_ADD(LOG_FLOAT, varY, &estimatorTask.kalmanData.P[KalmanFilter::KC_STATE_Y][KalmanFilter::KC_STATE_Y])
    LOG_ADD(LOG_FLOAT, varZ, &estimatorTask.kalmanData.P[KalmanFilter::KC_STATE_Z][KalmanFilter::KC_STATE_Z])
    LOG_ADD(LOG_FLOAT, varPX, &estimatorTask.kalmanData.P[KalmanFilter::KC_STATE_PX][KalmanFilter::KC_STATE_PX])
    LOG_ADD(LOG_FLOAT, varPY, &estimatorTask.kalmanData.P[KalmanFilter::KC_STATE_PY][KalmanFilter::KC_STATE_PY])
    LOG_ADD(LOG_FLOAT, varPZ, &estimatorTask.kalmanData.P[KalmanFilter::KC_STATE_PZ][KalmanFilter::KC_STATE_PZ])
    LOG_ADD(LOG_FLOAT, varD0, &estimatorTask.kalmanData.P[KalmanFilter::KC_STATE_D0][KalmanFilter::KC_STATE_D0])
    LOG_ADD(LOG_FLOAT, varD1, &estimatorTask.kalmanData.P[KalmanFilter::KC_STATE_D1][KalmanFilter::KC_STATE_D1])
    LOG_ADD(LOG_FLOAT, varD2, &estimatorTask.kalmanData.P[KalmanFilter::KC_STATE_D2][KalmanFilter::KC_STATE_D2])
    LOG_ADD(LOG_FLOAT, q0, &estimatorTask.kalmanData.q[0])
    LOG_ADD(LOG_FLOAT, q1, &estimatorTask.kalmanData.q[1])
    LOG_ADD(LOG_FLOAT, q2, &estimatorTask.kalmanData.q[2])
    LOG_ADD(LOG_FLOAT, q3, &estimatorTask.kalmanData.q[3])
LOG_GROUP_STOP(kalman)

    LOG_GROUP_START(kalman_pred)
    LOG_ADD(LOG_FLOAT, predNX, &estimatorTask.predictedNX)
    LOG_ADD(LOG_FLOAT, predNY, &estimatorTask.predictedNY)
    LOG_ADD(LOG_FLOAT, measNX, &estimatorTask.measuredNX)
    LOG_ADD(LOG_FLOAT, measNY, &estimatorTask.measuredNY)
...
LOG_GROUP_STOP(controller)
    ...
    LOG_ADD_CORE(LOG_FLOAT, x, &coreTask.state.x)
    LOG_ADD_CORE(LOG_FLOAT, y, &coreTask.state.y)
    LOG_ADD_CORE(LOG_FLOAT, z, &coreTask.state.z)
    LOG_ADD_CORE(LOG_FLOAT, vx, &coreTask.state.dx)
    LOG_ADD_CORE(LOG_FLOAT, vy, &coreTask.state.dy)
    LOG_ADD_CORE(LOG_FLOAT, vz, &coreTask.state.dz)
    LOG_ADD_CORE(LOG_FLOAT, roll, &coreTask.state.phi)
    LOG_ADD_CORE(LOG_FLOAT, pitch, &coreTask.state.theta)
    LOG_ADD_CORE(LOG_FLOAT, yaw, &coreTask.state.psi)
